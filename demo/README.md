...
- `app/channels/document_channel.rb` and the `lexxy_realtime_updates`
  migration — generated by `rails g lexxy_realtime:install` (the update-log
  model ships in the gem)
