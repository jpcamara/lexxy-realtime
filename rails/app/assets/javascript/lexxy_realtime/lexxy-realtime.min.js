...
`,document.head.appendChild(n)}let sd,cd;function ld(e){cd=e}function ud(){return typeof cd==`function`&&(cd=cd()),cd||(sd??=Pu())}var dd=class extends HTMLElement{#e=null;connectedCallback(){if(this.editorElement=this.closest(`lexxy-editor`),!this.editorElement){console.error(`<lexxy-collaboration> must be placed inside a <lexxy-editor>.`);return}this.editor=this.editorElement.editor,this.editor?this.#t():this.editorElement.addEventListener(`lexxy:initialize`,()=>{this.editor=this.editorElement.editor,this.#t()},{once:!0})}disconnectedCallback(){this.#e?.()}#t(){let e=this.getAttribute(`doc-id`)||`main`,t=this.getAttribute(`name`)||`Example User`,n=this.getAttribute(`color`)||`#958DF1`,r=this.getAttribute(`channel-name`)||`SyncChannel`,i=this.getAttribute(`channel-params`)||`{}`,a;try{a=typeof i==`string`?JSON.parse(i):i}catch{console.error(`<lexxy-collaboration>: invalid channel-params attribute (expected JSON); using {}.`,i),a={}}let o=!this.provider,s=!this.doc,c=this.doc||new Ei,l=this.provider||new Qu(c,this.consumer||ud(),r,a);o&&l.connect();let u=l.awareness,d=new Map;d.set(e,c);let f=this.editor.getEditorState();this.editor.update(()=>g().clear(),{tag:_e,discrete:!0});let p=td(this.editor),m=fu(this.editor,l,e,c,d,p);nd(m);let h=md(this.editor,l,m),_=pd(this.editor,l,m,f);od(this.editor);let ee=this.#n();m.cursorsContainer=ee,pu(l,t,n,!0,{name:t,color:n}),mu(l,t,n,!0,{name:t,color:n});let te=rd(this.editorElement,this.editor,l,u),ne=()=>hu(m,l);u.on(`update`,ne);let re=this.editor.registerUpdateListener(ne);hu(m,l),this.provider=l,this.doc=c,this.awareness=u,this.binding=m,this.#e=()=>{this.#e=null,te(),u.off(`update`,ne),re(),h(),_(),ee.remove(),o&&(l.disconnect(),this.provider=null),s&&(this.doc=null)}}#n(){let e=this.editorElement.querySelector(`.lexxy-editor-container`)||this.editorElement;getComputedStyle(e).position===`static`&&(e.style.position=`relative`);let t=document.createElement(`div`);return t.className=`lexxy-collab-cursors`,t.style.cssText=`position:absolute;inset:0;pointer-events:none;`,e.appendChild(t),t}};function fd(e){return e.read(()=>{let e=g();if(e.getChildrenSize()===0)return!0;let t=e.getChildrenSize()===1&&e.getFirstChild();return!!t&&t.getType()===`paragraph`&&t.getChildrenSize()===0})}function pd(e,t,n,r){let i=!1,a=()=>{if(!(i||!t.synced)&&(i=!0,s&&clearInterval(s),n.root.getSharedType().length===0)){if(r&&!fd(r)){e.setEditorState(r,{tag:_e});return}e.update(()=>{let e=g();e.clear(),e.append(o())},{tag:_e})}},s;return t.whenSynced?.then?t.whenSynced.then(a,()=>{}):(s=setInterval(a,50),typeof s?.unref==`function`&&s.unref()),()=>{i=!0,s&&clearInterval(s)}}function md(e,t,n){let r=e.registerUpdateListener(({dirtyElements:r,dirtyLeaves:i,editorState:a,normalizedNodes:o,prevEditorState:s,tags:c})=>{e.getEditorState().read(()=>{c.has(`skip-collab`)===!1&&gu(n,t,s,a,r,i,o,c)})}),i=(e,r)=>{r.origin!==n&&_u(n,t,e,!1)};return n.root.getSharedType().observeDeep(i),()=>{r(),n.root.getSharedType().unobserveDeep(i)}}customElements.get(`lexxy-collaboration`)||customElements.define(`lexxy-collaboration`,dd);export{dd as Collaboration,Qu as YrbyProvider,ld as setConsumer};